        ...
        <>
            {!loading && 
                <Link to={`/movie/${props.movieData.id}`
                    ...
                    className="group relative w-full flex-1 overflow-hidden rounded-2xl bg-black transition-all hover:grow-[1.25]">
                    <div className="relative w-full flex-1 overflow-hidden rounded-2xl bg-black transition-all group-hover:grow-[1.25]">
                        <LazyLoadImage
