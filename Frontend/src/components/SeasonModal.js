                        ...
                        <div class="bg-white/5 flex-grow w-full">
                            <div class="w-full p-2 py-3">
                                <div class="w-full no-scrollbar-atAll relative rounded-xl overflow-hidden ">
                                    ...
                                    <div class="flex overflow-x-scroll w-full gap-x-2 no-scrollbar-atAll">
                                        {
                                            showData?.seasons?.map((element, index) => {
                                                return (
                                                    <a title={`season${element.season_number}`} class="shrink-0 group relative w-1/4 2xl:w-1/5 !aspect-[2/1] overflow-hidden rounded-xl cursor-pointer" href={`/tv/1668/${element.season_number}/1`}>
                                                        <div class="w-full h-full bg-white/5 rounded-xl shadow-lg overflow-hidden smoothie"><span class=" lazy-load-image-background blur lazy-load-image-loaded" ><img alt="" src={`https://image.tmdb.org/t/p/w342/${element.poster_path || seasonData.poster_path}`} width="100%" height="100%" class="w-full h-full object-cover brightness-[.7] group-hover:scale-[1.04] overflow-hidden smoothie" /></span></div>
